/**
 * 生成地图数据  
 * series.mapType   (可选 world,china)
 * series.data 数据 和 series.markline.data 数据来自后台
 * 
 */
function  optionMap(mapType){
    ...
    var  option = {
					    backgroundColor: '#023a60', //蓝色背景  默认无背景
					    color: [
					        '#f6dda4',
					    ],
					    title : {
					    ...
					    tooltip : {//鼠标移动显示攻击次数
					        ...
					        formatter:   function (params) {
					           if(params[2]=='-'){
					        	  ...
					        	  return params[1]+'</br>攻击次数'+params[2];
					           }
					        }
					    	/* '{b}</br>攻击次数{c}' */
					    ...
					    series : [
					        {
					            name: '远程控制木马',
					            hoverable:true,//移动高亮显示
					            type: 'map',
					            roam: false,//是否开启滚轮缩放和拖拽漫游
					           // scaleLimit:{min:1,max:1},
					            scaleLimit:{min:0.5,max:15},//放大比例
					            mapType:'world',
					            showLegendSymbol:false,//显示图例颜色标识（系列标识的小圆点），存在legend时生效
					            /* itemStyle:{//设置地图颜色为绿色
					                normal:{
					                    areaStyle:{
					                        color: 'rgb(113,166,75)'
					                    }
					                }
					            }, */
					          //********************************数据来自后台
					           data:[{'geoCoord':[67.709953,33.93911],name:'阿富汗',value:11},{'geoCoord':[17.873887,-11.202692],name:'安哥拉',value:22}],
					            markLine : {
					                smooth:true,
					                effect : {
					                    show: true,
					                ...
					                //********************************数据来自后台
                                  data:[[{'geoCoord':[67.709953,33.93911],name:'阿富汗',value:11},{geoCoord:[104.195397,35.86166],name:'中国'}],[{'geoCoord':[17.873887,-11.202692],name:'安哥拉',value:22},{geoCoord:[104.195397,35.86166],name:'中国'}]]
					            },
					            markPoint : {
					                symbol:'emptyCircle',
